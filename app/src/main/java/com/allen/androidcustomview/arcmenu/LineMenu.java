...
/**
 */
public class LineMenu extends ViewGroup implements OnClickListener {
     ...
     * @param defStyle
     */
    public LineMenu(Context context, AttributeSet attrs, int defStyle) {
