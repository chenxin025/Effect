...
public class SnowFlyView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.i("snow","====xWidth=="+xWidth+"   yHeight="+yHeight);
    }
    ...
    private float randomY(int bpHeight) {
       ...
       // return yHeight;
       //return  bpHeight +  yRandom.nextFloat() * (yHeight -bpHeight);
        //return bpHeight - (initToTop + yRandom.nextFloat() * (yHeight - bpHeight));
    }
}
