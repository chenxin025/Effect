package com.allen.androidcustomview.circlemenu;
 ...
 * 圆环  建模分四个象限  注意正负数
 * 原理:  Down 记录点击的X, Y  Move 记录当前X  Y   获取变化的角度  onLayout 做移动角度处理
 * </pre>
 */
public class CircleMenuLayout extends ViewGroup
{
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		Log.i("menu","=====getChildCount====="+getChildCount());
		// menu item尺寸
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b)
	{
		...
		Log.i("menu","=====onLayout    getChildCount====="+getChildCount());
	...
	private void addMenuItems()
	{
		...
		Log.i("menu","=====addView    getChildCount====="+getChildCount());
	}
